...
ifeq ($(MODULE_C_EXTENSION),)
MODULE_C_EXTENSION := c
endif
...
ifeq ($(MODULE_ASM_EXTENSION),)
MODULE_ASM_EXTENSION := S
endif

# create a separate list of objects per source type
MODULE_CSRCS := $(filter %.$(MODULE_C_EXTENSION),$(MODULE_SRCS))
MODULE_CPPSRCS := $(filter %.$(MODULE_CPP_EXTENSION),$(MODULE_SRCS))
MODULE_ASMSRCS := $(filter %.$(MODULE_ASM_EXTENSION),$(MODULE_SRCS))

MODULE_COBJS := $(call TOBUILDDIR,$(patsubst %.$(MODULE_C_EXTENSION),%.o,$(MODULE_CSRCS)))
MODULE_CPPOBJS := $(call TOBUILDDIR,$(patsubst %.$(MODULE_CPP_EXTENSION),%.o,$(MODULE_CPPSRCS)))
MODULE_ASMOBJS := $(call TOBUILDDIR,$(patsubst %.$(MODULE_ASM_EXTENSION),%.o,$(MODULE_ASMSRCS)))

# do the same thing for files specified in arm override mode
MODULE_ARM_CSRCS := $(filter %.$(MODULE_C_EXTENSION),$(MODULE_ARM_OVERRIDE_SRCS))
MODULE_ARM_CPPSRCS := $(filter %.$(MODULE_CPP_EXTENSION),$(MODULE_ARM_OVERRIDE_SRCS))
MODULE_ARM_ASMSRCS := $(filter %.$(MODULE_ASM_EXTENSION),$(MODULE_ARM_OVERRIDE_SRCS))

MODULE_ARM_COBJS := $(call TOBUILDDIR,$(patsubst %.$(MODULE_C_EXTENSION),%.o,$(MODULE_ARM_CSRCS)))
MODULE_ARM_CPPOBJS := $(call TOBUILDDIR,$(patsubst %.$(MODULE_CPP_EXTENSION),%.o,$(MODULE_ARM_CPPSRCS)))
MODULE_ARM_ASMOBJS := $(call TOBUILDDIR,$(patsubst %.$(MODULE_ASM_EXTENSION),%.o,$(MODULE_ARM_ASMSRCS)))

MODULE_OBJS := $(MODULE_COBJS) $(MODULE_CPPOBJS) $(MODULE_CCOBJS) $(MODULE_ASMOBJS) $(MODULE_ARM_COBJS) $(MODULE_ARM_CPPOBJS) $(MODULE_ARM_ASMOBJS)
...
$(MODULE_COBJS): $(BUILDDIR)/%.o: %.$(MODULE_C_EXTENSION) $(MODULE_SRCDEPS)
	@$(MKDIR)
	@echo compiling $<
...
$(MODULE_CPPOBJS): $(BUILDDIR)/%.o: %.$(MODULE_CPP_EXTENSION) $(MODULE_SRCDEPS)
	@$(MKDIR)
	@echo compiling $<
...
$(MODULE_ASMOBJS): $(BUILDDIR)/%.o: %.$(MODULE_ASM_EXTENSION) $(MODULE_SRCDEPS)
	@$(MKDIR)
	@echo compiling $<
...
$(MODULE_ARM_COBJS): $(BUILDDIR)/%.o: %.$(MODULE_C_EXTENSION) $(MODULE_SRCDEPS)
	@$(MKDIR)
	@echo compiling $<
...
$(MODULE_ARM_CPPOBJS): $(BUILDDIR)/%.o: %.$(MODULE_CPP_EXTENSION) $(MODULE_SRCDEPS)
	@$(MKDIR)
	@echo compiling $<
...
$(MODULE_ARM_ASMOBJS): $(BUILDDIR)/%.o: %.$(MODULE_ASM_EXTENSION) $(MODULE_SRCDEPS)
	@$(MKDIR)
	@echo compiling $<
