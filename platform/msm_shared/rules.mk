...
MODULE_CFLAGS += -DSPLASH_PARTITION_NAME=$(SPLASH_PARTITION_NAME)
else
MODULE_CFLAGS += -DSPLASH_PARTITION_NAME=\"splash\"
endif
...
MODULE_DEFINES += DISPLAY_2NDSTAGE_FBADDR=$(DISPLAY_2NDSTAGE_FBADDR)
endif
