...
GLOBAL_COMPILEFLAGS := -g -fno-builtin -finline -W -Wall -Wextra -Wno-multichar -Wno-unused-parameter -Wno-unused-function -include $(CONFIGHEADER)
GLOBAL_CFLAGS := --std=gnu99 -Werror-implicit-function-declaration -Wstrict-prototypes -Werror
